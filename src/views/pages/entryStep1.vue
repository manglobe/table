	...
	<div>
		...
		<div class="entry-step entry-step-1">
			<div class="qulity-form">
		    	<span class="input-wrap" style="margin-right: 25px;">
						...
						<div
						  ...
						  :key="index">
							...
							<i 
							  ...
							  style="cursor: pointer;margin-left: 10px;vertical-align:top;margin-top:9px;"
		...
		methods: {
			...
			gotoStep(num) {
				this.validate = {
					...
					quotaDefinitions : this.$validate.array(this.oldBaseInfo.quotaDefinitions),
...
<style rel="stylesheet/scss" lang="scss">
	.entry-step-1 {		
		...
		.el-input.warning, .el-select.warning {
			.el-input__inner {
