		...
		methods: {
			...
			loadIndicators() {
				...
				this.params = {
					...
					recordStartDate: (this.dateRange[0] != null && this.dateRange.length != 0) ? (this.$dateHandle.dateArrayFormat(this.dateRange)[0] + ' 00:00:00') : '',
					recordEndDate: (this.dateRange[0] != null && this.dateRange.length != 0) ? (this.$dateHandle.dateArrayFormat(this.dateRange)[1] + ' 23:59:59') : '',
				...
				this.$service.getIndicators(this.params).then(res => {
					this.tableLoading = false;
					[this.tableData, this.totalPages] = [res.responseData.resultList, res.responseData.totalCount]
				})
			},
